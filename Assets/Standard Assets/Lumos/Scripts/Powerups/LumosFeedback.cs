...
/// A custom GUI can be used instead of the default one by calling Record
/// before submitting.
/// </summary>
public class LumosFeedback
{
	...
	const int windowId = 345992; // Random to be different another window ID.
	const int margin = 10;
	...
	public static void Record (string message, string email, string type)
	{
		...
		LumosRequest.Send("feedback.record", parameters);
	}*/
}
